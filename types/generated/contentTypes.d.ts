...
export interface ApiAnalysisResultAnalysisResult
  extends Struct.CollectionTypeSchema {
  collectionName: 'analysis_results';
  info: {
    description: 'Stores the latest health analysis result for each user';
  ...
  attributes: {
    analysis_data: Schema.Attribute.JSON & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiUserFileUserFile extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Stores medical files (photos and PDFs) uploaded by users';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    file_data: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    file_name: Schema.Attribute.String & Schema.Attribute.Required;
    file_type: Schema.Attribute.Enumeration<['photo', 'pdf']> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
